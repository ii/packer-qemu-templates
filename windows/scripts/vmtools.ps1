...
switch ($env:PACKER_BUILD_NAME) {
	...
	default {
          Write-Host -ForegroundColor Red "Unknown Packer builder!"
          Write-Host -ForegroundColor Red $env:PACKER_BUILD_NAME
          Write-Host -ForegroundColor Red "XXXXXXXX Installing for Openstack XXXXXXXX"
          #Start-Sleep -Seconds 120  #PAUSE to get our attention
          Setup-OpenStack
          #Start-Sleep -Seconds 120  #PAUSE to get our attention
          }
}
